...
namespace System.Diagnostics.Metrics
{
    ...
    internal partial struct ObjectSequence3 : IEquatable<ObjectSequence3>, IObjectSequence
    {
        ...
        public override readonly int GetHashCode() => HashCode.Combine(Value1, Value2, Value3);
    }

    internal readonly partial struct ObjectSequenceMany : IEquatable<ObjectSequenceMany>, IObjectSequence
    {

        public readonly Span<object?> AsSpan()
        {
