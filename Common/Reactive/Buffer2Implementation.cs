...
internal sealed class Buffer2Implementation : IBuffer2Implementation
{
    ...
    public IObservable<IList<TSource>> Buffer2<TSource>(IObservable<TSource> source, TimeSpan timeSpan, int count, IScheduler scheduler)
    {
        return Buffer2_(source, timeSpan, count, scheduler);
    }
