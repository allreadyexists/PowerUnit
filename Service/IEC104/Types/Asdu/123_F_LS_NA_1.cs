...
public readonly struct F_LS_NA_1
{
    ...
    public static void Parse(Span<byte> buffer, ref AsduPacketHeader_2_2 header, DateTime dateTime, IAsduNotification notification)
    {
        ...
        notification.Notify_F_LS_NA(ref header, value.Address, value.NOF, value.NOS, value.LSQ, value.CHS);
    }

    public static int Serialize(byte[] buffer, ref AsduPacketHeader_2_2 header, ref F_LS_NA_1 F_LS_NA_1)
    {
