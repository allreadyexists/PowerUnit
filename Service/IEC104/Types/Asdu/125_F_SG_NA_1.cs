...
public readonly struct F_SG_NA_1
{
    ...
    public static void Parse(Span<byte> buffer, ref AsduPacketHeader_2_2 header, DateTime dateTime, IAsduNotification notification)
    {
        ...
        notification.Notify_F_SG_NA(ref header, value.Address, value.NOF, value.NOS, buffer[Size..(Size + value.LOS)].ToArray());
    }

    public static int Serialize(byte[] buffer, ref AsduPacketHeader_2_2 header, ref F_SG_NA_1 F_SG_NA_1, byte[] segment)
    {
