...
internal sealed class DiscretValueTestDataSource : TestDataSource<DiscretValue>
{
    public DiscretValueTestDataSource(TimeProvider timeProvider, ILogger<DiscretValueTestDataSource> logger) : base(timeProvider, logger)
    { }
