...
//internal sealed class TestDataProvider : IDataProvider
//{
//    IAsyncEnumerable<AnalogValue> IDataProvider.GetAnalogGroup(int serverId, QOI qoi, CancellationToken ct) => AsyncEnumerable.Empty<AnalogValue>();
//    Task<AnalogValue?> IDataProvider.GetAnalogValue(int serverId, ushort address, CancellationToken ct) => Task.FromResult<AnalogValue?>(null);
//    IAsyncEnumerable<DiscretValue> IDataProvider.GetDiscretGroup(int serverId, QOI qoi, CancellationToken ct) => AsyncEnumerable.Empty<DiscretValue>();
//    Task<DiscretValue?> IDataProvider.GetDiscretValue(int serverId, ushort address, CancellationToken ct) => Task.FromResult<DiscretValue?>(null);
//}
